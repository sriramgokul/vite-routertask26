...
function App() {
  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Route path='/details/fsd' element={<FullStackDevelopment data={data}/>}/>
      <Route path='/details/datascience' element={<DataScience data={data}/>}/>
      <Route path='/details/cybersecurity' element={<CyberSecurity data={data}/>}/>
      <Route path='/details/Career' element={<Career data={data}/>}/>
